...
SWIGINTERN PyObject *_wrap_curve_AnnualRate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  curve *arg1 = (curve *) 0 ;
  long arg2 ;
  long arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:curve_AnnualRate",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_curve, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "curve_AnnualRate" "', argument " "1"" of type '" "curve *""'"); 
  }
  arg1 = reinterpret_cast< curve * >(argp1);
  ecode2 = SWIG_AsVal_long(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "curve_AnnualRate" "', argument " "2"" of type '" "long""'");
  } 
  arg2 = static_cast< long >(val2);
  ecode3 = SWIG_AsVal_long(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "curve_AnnualRate" "', argument " "3"" of type '" "long""'");
  } 
  arg3 = static_cast< long >(val3);
  result = (double)(arg1)->AnnualRate(arg2,arg3);
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"curve_AnnualRate", _wrap_curve_AnnualRate, METH_VARARGS, NULL},
